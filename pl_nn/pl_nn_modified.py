...
class PlNearestNeighborsTest:
    def __init__(self, angle_threshold=60):
        ...
        self.angle_threshold = angle_threshold  # Added angle_threshold attribute
    ...
    def predict(self, X):
        ...
        for t in X:
            ...
            nearest_neighbors = nearest_neighbors[np.abs(angles) <= self.angle_threshold]  # Using angle_threshold here
